...
\end{figure}
 ...
 最后，仿照问题二，将运动过程可视化，可验证龙头前把手与原点距离 449.9477cm 处板凳发生碰撞，且在此之前无板凳发生碰撞，从而验证了模型的可靠性。
	...
	\begin{thebibliography}{9}
		\bibitem{ref1}郭小沅,王明建. 达州民俗体育安仁板凳龙的现状考察与优化路径研究[D]. 成都体育学院, 2021.
		\bibitem{ref2} 张利彪,周春光,马铭,刘小华. 基于粒子群算法求解多目标优化问题[J]. 计算机研究与发展,2004,41(7):1287-1290.
		\bibitem{ref3} 司守奎,孙兆亮. 数学建模算法与应用[M]. 北京:国防工业出版社,2017.
		\bibitem{ref4} 朱颢东,钟勇. 一种改进的模拟退火算法[J]. 计算机技术与发展,2009, 19(6):32-35.
		\bibitem{ref5} 姜启源,谢金星,叶俊.数学模型[M]. 北京:高等教育出版社,2011.
	\end{thebibliography}
